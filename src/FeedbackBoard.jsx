...
const reportTranslations = {
  en: {
    ...
    action: "To support {poss} progress, we will collaborate to improve {poss} {w1} and {w2}.",
  ...
  ms: {
    ...
    action: "Untuk menyokong kemajuannya, kami akan bekerjasama untuk meningkatkan {w1} dan {w2}.",
  ...
  zh: {
    ...
    action: "为了支持{poss}进步，我们将共同努力提高{poss}{w1}和{w2}。",
  ...
  th: {
    ...
    action: "เพื่อสนับสนุนความก้าวหน้าของ{poss} เราจะร่วมมือกันเพื่อปรับปรุง{w1}และ{w2}ของ{poss}",
  ...
  id: {
    ...
    action: "Untuk mendukung kemajuannya, kami akan bekerja sama untuk meningkatkan {w1} dan {w2}.",
  ...
  vi: {
    ...
    action: "Để hỗ trợ sự tiến bộ của {poss}, chúng tôi sẽ phối hợp để cải thiện kỹ năng {w1} và {w2} của {poss}.",
  ...
  ar: {
    ...
    action: "لدعم تقدم{poss}، سنتعاون لتحسين {w1} و {w2}.",
  ...
  tr: {
    ...
    action: "{poss} gelişimini desteklemek için, {w1} ve {w2} becerilerini geliştirmek üzere işbirliği yapacağız.",
